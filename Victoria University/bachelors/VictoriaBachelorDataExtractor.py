...
url = 'https://www.vu.edu.au/courses/international/ABAB'
#url = line
...
test_df.to_csv(r'/Users/zeinalabidin/desktop/CSV_files/VictoriaUniversityBachelorCourses71.csv', index=False,header=True)
